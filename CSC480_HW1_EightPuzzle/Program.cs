...
namespace CSC480_HW1_EightPuzzle
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            root.TotalTilesOutOfPlace = StateNode.NumTilesOutOfPlace(root);
           ...
           // Stack<StateNode> stack = new Stack<StateNode>();
            ...
            // Greedy Best First Search based on h(n) number of tiles out of place
            ...
            pq.Add(root.TotalTilesOutOfPlace, root);
            SizeOfPQ = SizeOfPQ + 1;
            MaxOfPQ = MaxOfPQ + 1;
            ...
            while (keepRunning)
            {
                ...
                while (qFromSuccessorFunction.Count != 0)
                {
                    ...
                    {
                        pq.Add(removeFromFrontOfSuccessorQueue.TotalTilesOutOfPlace, removeFromFrontOfSuccessorQueue);
