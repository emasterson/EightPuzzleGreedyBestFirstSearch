...
namespace CSC480_HW1_EightPuzzle
{
    public class StateNode  
    {
        ...
        public int TotalTilesOutOfPlace = 0;
        ...
        //public static void Successor(StateNode sNode)
        {
           ...
           // Make 4 Nodes
            ...
            // CHECK TO SEE HOW MANY TILES OUT OF PLACE
            ...
            switch (sNode.zeroPosition)
            {
                case 0:
                   ...
                   // Console.WriteLine("Case0\n\n");
                    ...
                    sNodeLeft.TotalTilesOutOfPlace = NumTilesOutOfPlace(sNodeLeft);
                    // move up
                    ...
                    sNodeUp.TotalTilesOutOfPlace = NumTilesOutOfPlace(sNodeUp);
                ...
                case 1:
                   // Console.WriteLine("Case1\n\n");
                    ...
                    sNodeRight.TotalTilesOutOfPlace = NumTilesOutOfPlace(sNodeRight);
                    // move left
                ...
                case 3:
                  //  Console.WriteLine("Case3\n\n");
                    ...
                    sNodeDown.TotalTilesOutOfPlace = NumTilesOutOfPlace(sNodeDown);
                    // move left
